										...
										<div class="row" id="overviewScreen">
											<div class="col-xs-12 col-md-7">
												<div class="col-xs-12 col-md-12" align="center">
													<div style="clear: both;" class="hidden-md hidden-lg">
														<h3 class="fullname" style="padding: 0px; text-align: center; font-size: 1.5em; font-weight: bold;">Compléter la réparation
                                                                                                                ...
                                                                                                                <span style="font-weight: 200; font-family: gilroyextra, uniform, helvetica, Arial;"> | GENRE : 
                                                                                                                        MARQUE TYPE</span></h3>
													</div>
												...
												<div align="center">
													...
													<button id="confirmdevice" class="btn btn-primary" style="padding: 10px; width: 120px; margin: 5px;">Confirmer </button>
												</div>
												<div style="clear: both;"></div>
												<br>
...
Mooi gefixt.<br>
            ...
            MARQUE TYPE<small> | </small><br><span>TYPE_REP</span></div>
													...
													<p class="voldoen" style="border-color: #BABABA;">
														<b>Coût de réparation  
														<span class="productprice"> PRIX DHS</span></b>
													</p>
													<div align="center">
														<button type="button" name="prev" class="btn btn-vorige" style="padding: 10px; width: 120px; margin: 5px;"> Retour</button>
