...
<div id="global-sum" class="step-content-body">
	...
	<div class="row">
		<div class="col-xs-12 col-md-12">
			<div class="row" id="overviewScreen">
				<div class="col-xs-12 col-md-7">
					<div class="col-xs-12 col-md-12" align="center">
						<div style="clear: both;" class="hidden-md hidden-lg">
							<h3 class="fullname" style="padding: 0px; text-align: center; font-size: 1.5em; font-weight: bold;">Compléter la réparation
								
																					<span style="font-weight: 200; font-family: gilroyextra, uniform, helvetica, Arial;"> | {{$genre=$mobile->genre_mobile}} : 
									{{$marque=$mobile->marque_mobile}} {{$type=$mobile->type_mobile}}</span></h3>
						</div>
						<div style="clear: both;" class="hidden-sm hidden-xs">
							<h3 class="fullname" style="padding: 20px; text-align: center; font-size: 1.5em; font-weight: bold;">Compléter la réparation
								<span style="font-weight: 200; font-family: gilroyextra, uniform, helvetica, Arial;"> | {{$genre=$mobile->genre_mobile}} : 
									{{$marque=$mobile->marque_mobile}} {{$type=$mobile->type_mobile}}</span></h3>
						</div>
					</div>
						...
						<div class="col-md-12" align="center">
							<div align="center" style="clear: both;">
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/speed.png')}}" width="60px" height="60px" style="display: block;"><br>
									<p style="text-align: center;"><b>Réparation </b><br><span class="repairtime">Rapide</span></p>
									<br>
								</div>
								
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/garantie.png')}}" width="60px" height="60px" style="display: block;"><br>
									<p style="text-align: center;"><b>Garantie</b><br><span class="warrantyTime">12 mois</span></p>
									<br>
								</div>
								
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/privacy.png')}}" width="60px" height="60px" style="display: block;"><br>
									<p class="stock" style="text-align: center;"><b>Sécurité</b><br>des données</p>
									<br>
								</div>
								
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/livee.png')}}" width="60px" height="60px" style="display: block;"><br>
									<p style="text-align: center; "><b>Regarder</b><br>en direct</p>
									<br>
								</div>
							</div>
						</div>
					...
					<div style="clear: both;" class="hidden-md hidden-lg">
						<div class="col-md-12" align="center">
							<div align="center" style="clear: both;">
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/speed.png')}}" width="50px" height="50px" style="display: block;"><br>
									<p style="text-align: center;  font-size: 13px; "><b>Réparation</b><br><span class="repairtime">Rapide</span></p>
									<br>
								</div>
								
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/garantie.png')}}" width="50px" height="50px" style="display: block;"><br>
									<p style="text-align: center;   font-size: 13px; "><b>Garantie</b><br><span class="warrantyTime">12 mois</span></p>
									<br>
								</div>
								
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/privacy.png')}}" width="50px" height="50px" style="display: block;"><br>
									<p class="stock" style="text-align: center;   font-size: 13px; "><b>Sécurité </b><br>des données</p>
									<br>
								</div>
								
								<div class="col-md-3 col-xs-3" style="padding: 10px;">
									<img src="{{asset('../img/livee.png')}}" width="50px" height="50px" style="display: block;"><br>
									<p style="text-align: center;   font-size: 13px;  "><b>Regarder</b><br>en direct</p>
									<br>
								</div>
							</div>
						</div>
					...
					<div align="center">
						...
						<a href="{{url('reparation/' . $genre .'/'. $marque . '/' . $type .'/typerep')}}">
								<button type="button" name="" class="btn btn-vorige" 
									style="padding: 10px; width: 120px; margin: 5px;"> Retour</button> </a>
						
						<a href="{{url('reparation/' . $genre .'/'. $marque . '/' . $type .'/'. $typerep .'/'. $prixrep. '/infosC')}}">
								<button 
										class="btn btn-primary" style="padding: 10px; width: 120px; margin: 5px;">Confirmer </button></a>
					</div>
					<div style="clear: both;"></div>
					<br>
...
<!-- *************** RECENSIES ********************* -->
					...
					<div>
						<h2 class="linethrough" style="text-align: center; border-bottom: 1px solid #000;"><span style="position:relative;top:14px;background: #F4F4F4;padding: 0 10px;">AVIS</span></h2>
						<br>
					</div>
					<br>
	...
	<!-- Les informations du prix et adresse .... etc. -->
				...
				<div class="col-xs-12 col-md-5">
					<div class="repairings">
						...
						<div class="col-md-8  col-xs-8 productinfo">{{$genre=$mobile->genre_mobile}} : 
{{$marque=$mobile->marque_mobile}} {{$type=$mobile->type_mobile}}<small> | </small><br><span>{{$typerep=$mobile->type_typerep}}</span></div>
						...
						<div class="col-md-8 col-xs-8">
							<span class="greyedout">Informations du client</span><br>
						...
						<a href="{{url('reparation/' . $genre .'/'. $marque . '/' . $type .'/typerep')}}">
							<button type="button" name="prev" class="btn btn-vorige" 
												style="padding: 10px; width: 120px; margin: 5px;"> Retour</button></a>
							<a href="{{url('reparation/' . $genre .'/'. $marque . '/' . $type .'/'. $typerep .'/'. $prixrep. '/infosC')}}"><button 
										class="btn btn-primary" style="padding: 10px; width: 120px; margin: 5px;">Confirmer </button></a>
						</div>
					</div>
					<br>
